...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    },
    {
        ...
        "description": "YYDS 临时邮箱 API，创建邮箱后用邮箱 token 轮询验证码",
        "driver_type": "generic_http_mailbox",
        "default_auth_mode": "apikey",
        "enabled": True,
        "category": "thirdparty",
        ...
        "fields": [
            ...
            {"key": "yyds_api_key", "label": "API Key", "secret": True, "category": "auth"},
        ],
        "metadata": {
            "email_mode": "generate",
            "response_list_path": "data.messages",
            ...
            "create_email": {
                ...
                "body": {"autoDomainStrategy": "prefer_owned"},
                "extract": {
                    "email": "data.address",
                    "account_id": "data.token",
                },
            },
            "list_emails": {
                "method": "GET",
                "path": "/messages",
                "headers": {"Authorization": "Bearer {account_id}"},
    ...
    },
    {
        ...
        "label": "SMSBower Mail",
        "description": "SMSBower 临时邮箱 API，支持按 service/domain 获取邮箱并轮询验证码",
        ...
        "auth_modes": [{"value": "apikey", "label": "API Key"}],
        "fields": [
            {"key": "smsbower_mail_api_key", "label": "API Key", "secret": True, "category": "auth"},
            {"key": "smsbower_mail_service", "label": "服务代码", "placeholder": "go", "default_value": "go", "category": "connection"},
            {"key": "smsbower_mail_domain", "label": "邮箱域名", "placeholder": "gmail.com", "default_value": "gmail.com", "category": "connection"},
            {"key": "smsbower_mail_max_price", "label": "最大价格 (可选)", "placeholder": "", "category": "connection"},
            {"key": "smsbower_mail_alias", "label": "启用 alias", "type": "toggle", "category": "connection"},
            {"key": "smsbower_mail_reuse_limit", "label": "单邮箱最多取码次数", "placeholder": "5", "default_value": "5", "category": "connection"},
            {"key": "smsbower_mail_alias_prefix", "label": "别名前缀", "placeholder": "gpt", "default_value": "gpt", "category": "connection"},
            {"key": "smsbower_mail_manual_activations", "label": "手动邮箱 activation", "type": "textarea", "placeholder": "email@gmail.com----11686414", "category": "connection"},
            {"key": "smsbower_mail_activation_wait_seconds", "label": "等待邮箱库存秒数", "placeholder": "0 = 一直等待", "default_value": "0", "category": "connection"},
            {"key": "smsbower_mail_activation_poll_interval", "label": "获取邮箱轮询间隔秒", "placeholder": "3", "default_value": "3", "category": "connection"},
            {"key": "smsbower_mail_api_url", "label": "API 地址（可选）", "placeholder": "https://smsbower.app", "category": "connection"},
        ],
    },
    # ── captcha ──────────────────────────────────────────────────────
    {
